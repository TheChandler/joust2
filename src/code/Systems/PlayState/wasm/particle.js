...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('particle.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('particle.wasm', import.meta.url).href;
}
...
var _get_x_positions = Module['_get_x_positions'] = makeInvalidEarlyAccess('_get_x_positions');
var _get_y_positions = Module['_get_y_positions'] = makeInvalidEarlyAccess('_get_y_positions');
var _get_x_vel = Module['_get_x_vel'] = makeInvalidEarlyAccess('_get_x_vel');
var _get_y_vel = Module['_get_y_vel'] = makeInvalidEarlyAccess('_get_y_vel');
...
function assignWasmExports(wasmExports) {
  Module['_get_x_positions'] = _get_x_positions = createExportWrapper('get_x_positions', 0);
  Module['_get_y_positions'] = _get_y_positions = createExportWrapper('get_y_positions', 0);
  Module['_get_x_vel'] = _get_x_vel = createExportWrapper('get_x_vel', 0);
  Module['_get_y_vel'] = _get_y_vel = createExportWrapper('get_y_vel', 0);
